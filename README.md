...
Проект разрабатывался в режиме AI-assisted development. В репозитории намеренно оставлен `CLAUDE.md` — файл с правилами для AI-ассистента (требования к достоверности, Clean Code, Clean Architecture, подходу к тестам), которыми я направлял генерацию и ревью кода. Все архитектурные решения, описанные выше, принимались осознанно и проверялись вручную.
